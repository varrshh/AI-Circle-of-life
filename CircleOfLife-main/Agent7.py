    ...
    def run(self, prey, predator, threshold = 200):
        ...
        while ((self.get_position()!=prey.get_position()) and (predator.get_position()!=self.get_position())):
            ...
            if count == 0 :
                ...
                self.update_predator_believes(predator, survey=False, FIRST_TIME = True) # Survey + update believes  # Initially it knows the location of the predator no need to survey
                self.update_prey_believes(prey, survey=True) # Survey + update believes #Agent 3 
                ...
                # 1. Survey and 2. update beliefs
                self.update_predator_believes(predator, survey=True, FIRST_TIME = False) # Survey + update believes #Agent 4
            ...
            #self.update_predator_believes(predator) # Only updates believes 
            # 8. Go to Step 1
            count+=1
